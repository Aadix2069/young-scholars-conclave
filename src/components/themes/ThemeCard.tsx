 ...
 * keyboard (Enter/Space) and announces its dialog state to screen readers
 * via aria-haspopup / aria-expanded / aria-controls.
 *
 * Memoized so only the toggled card re-renders when the selection changes.
 */
