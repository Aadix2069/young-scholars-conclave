# Deploying the registration/abstract backend

This connects the website's Registration and Submit Abstract forms to a Google Sheet, using `Code.gs` in this folder.

## 1. Create the Google Sheet

1. Go to [sheets.google.com](https://sheets.google.com) and create a new blank spreadsheet.
2. Name it something like "Young Scholars' Conclave 2026 — Submissions".
3. Leave it empty — the script creates its own "Registrations" and "Abstract Submissions" tabs automatically on first submission.
...
4. Click **Deploy**.
5. Google will ask you to authorize the script — click through the consent screens (you'll see an "unverified app" warning since this is your own script; click **Advanced → Go to (project name)** to proceed).
...
Once the env var is set and the site is running, submit a test entry through the Registration or Submit Abstract page and confirm a new row appears in the Sheet within a few seconds.
...
Saving alone does not update the live Web App — Apps Script Web Apps are versioned, and only a new deployment version picks up code changes.
